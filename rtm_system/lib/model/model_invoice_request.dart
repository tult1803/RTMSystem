...
InvoiceRequest invoiceRequestFromJson(String str) =>
    InvoiceRequest.fromJson(json.decode(str));
...
class InvoiceRequest {
  ...
  factory InvoiceRequest.fromJson(Map<String, dynamic> json) => InvoiceRequest(
        invoiceRequests: List<InvoiceRequestElement>.from(
            json["invoiceRequests"]
                .map((x) => InvoiceRequestElement.fromJson(x))),
        total: json["total"],
      );

  Map<String, dynamic> toJson() => {
        "invoiceRequests":
            List<dynamic>.from(invoiceRequests.map((x) => x.toJson())),
        "total": total,
      };
}
...
class InvoiceRequestElement {
  ...
  factory InvoiceRequestElement.fromJson(Map<String, dynamic> json) =>
      InvoiceRequestElement(
        id: json["id"],

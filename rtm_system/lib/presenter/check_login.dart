...
void checkSaveLogin(BuildContext context) async {
  ...
  try {
    if (prefs.getInt("role_id") == 3 && prefs.getBool("isLogin") == true) {
      ...
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (context) => HomeAdminPage(index: 0,)),
          (route) => false);
    }
  } catch (e) {
...
void savedInfoLogin(int roleId, String accountId, int gender, String accessToken, String fullname, String phone, String birthday, String password) async {
